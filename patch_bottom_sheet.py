...
if "import com.example.player.AudioEffectManager" not in content:
    content = content.replace("import androidx.media3.common.PlaybackParameters", "import androidx.media3.common.PlaybackParameters\n" + imports)

# We want to replace everything inside the modal bottom sheet
target_column_start = """        Column(
            modifier = Modifier
                .fillMaxWidth()
                .padding(24.dp),"""

replacement = """    val eqState by AudioEffectManager.eqState.collectAsState()
...
content = re.sub(r'    ModalBottomSheet\(onDismissRequest = onDismissRequest\) \{.*?\n\}\}', replacement, content, flags=re.DOTALL)
